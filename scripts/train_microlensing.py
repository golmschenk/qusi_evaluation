...
from qusi_evaluation.microlensing_dataset import get_microlensing_train_dataset

def main():
    train_light_curve_dataset = get_microlensing_train_dataset()
    validation_light_curve_dataset = get_microlensing_train_dataset()
    model = Hadryss.new()
